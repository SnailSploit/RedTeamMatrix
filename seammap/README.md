...
status (40 carry no ATT&CK id), and falsifiable validation. Full per-technique walkthroughs (attack mechanics + runnable PoC) are in [`docs/WALKTHROUGHS.md`](docs/WALKTHROUGHS.md).
