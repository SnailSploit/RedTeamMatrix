...
[`docs/NEW-TECHNIQUES.md`](docs/NEW-TECHNIQUES.md) (generated by `gen-new-techniques.cjs`): all 96
AGENT-DISCOVERED seams grouped by discovery round, each with its trust assumption, validity verdict, MITRE
